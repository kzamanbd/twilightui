    ...
    Alpine.data('mailbox', () => ({
        ...
        mailList: [
            ...
            <div class="gallery text-center">
                <img alt="image-gallery" src="${'/images/carousel3.jpeg'}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                <img alt="image-gallery" src="${'/images/carousel2.jpeg'}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
                <img alt="image-gallery" src="${'/images/carousel1.jpeg'}" class="mb-4 mt-4" style="width: 250px; height: 180px;" />
            </div>
        ...
        searchMails(isResetPage = true) {
            ...
            if (this.filteredMailList.length) {
                this.pager.totalPages =
                    this.pager.pageSize < 1 ? 1 : Math.ceil(this.filteredMailList.length / this.pager.pageSize);
        ...
        saveMail(type, id) {
            ...
            let maxId = 0;
            if (!this.params.id) {
                maxId = this.mailList.length
                    ? this.mailList.reduce(
