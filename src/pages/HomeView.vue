            ...
            <div class="login-bg">
                <div class="rounded-md bg-white px-8 py-6 shadow-md">
                    <div class="my-4 flex items-center justify-center space-x-2">
                        ...
                        <p class="dark--text text-3xl font-semibold">Twilight <span class="text-primary">UI</span></p>
                    </div>
                    <div class="my-3">
                        <p class="dark--text mb-2 text-2xl font-semibold">Welcome to Twilight!</p>
                    ...
                    <form class="my-3" @submit.prevent="login">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a class="block text-sm text-primary-600 hover:underline" href="/auth-forgot-password.html">
                                Forgot password?
                            </a>
                        </div>

                        <div class="mt-4">
                            <button v-ripple type="submit" :disabled="isLoading" class="btn btn-primary w-full">
                    ...
                    <p class="dark--text">
                        ...
                        <a href="/auth-register.html" class="text-primary">Sign up here</a>
                    </p>
                </div>
            </div>
        </div>
